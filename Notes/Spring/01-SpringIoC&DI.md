...
阐述了2EE开发不使用EB的解决方式（ Spring雏形）

2017年9月份发布了 Spring的最新版本 Spring5.0通用版（GA）
...
可以将我们从单调烦闷的事务管理代码中解脫出来，通过声明式方式灵活的进行事务管理，提高发效率和质量

**方便程序的测试**

Spring对各种优秀柱架（ Struts、 Hibernate、 Hessian、Quartz等）的支持。

**降低 JavaEE AP的使用难度**

Spring对 JavaEE APl（如JDBC、 Javamail、远程调用等）进行了薄薄的封装层，使这些AP的使用难度大为降低。

**Java源码是经典学习范例**

Spring的源代码设计精妙、结构凊晰、匠心独用，处处体现着大师对Java设计模式灵活运用以及对Java技术的高深造诣。它的源代码无意是Java技术的最佳实践的范例。
...
- ④在配置文件中进行配置
- ⑤创建 ApplicationContex对象 getBean
...
怎么将 UserDao怎样注入到 JserService内部呢？
...
![image-20210204161208993](images/image-20210204161208993.png)
...
![image-20210204161529388](images/image-20210204161529388.png)
